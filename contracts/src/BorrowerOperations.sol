    ...
    IBorrowerOperations
{
    ...
    function _openTrove(
        ...
        ITroveManager.Status status = vars.troveManager.getTroveStatus(
            vars.troveId
        );
    ...
    function adjustZombieTrove(
        ...
        if (!_checkTroveIsZombie(troveManagerCached, _troveId)) {
    ...
    function adjustTroveInterestRate(
        ...
        _requireValidDelegateAdustment(
            _troveId,
        ...
        //     _newAnnualInterestRate
        // );
        if (trove.annualInterestRate == _newAnnualInterestRate) {
    ...
    function registerBatchManager(
        ...
        if (interestBatchManagers[msg.sender].maxInterestRate > 0) {
    ...
    function removeFromBatch(
        ...
        batchChange.newWeightedRecordedDebt =
            ...
            _newAnnualInterestRate;
        // Add batch fees
        batchChange.oldWeightedRecordedBatchManagementFee = vars
            .batch
            .weightedRecordedBatchManagementFee;
        batchChange.newWeightedRecordedBatchManagementFee =
            batchFutureDebt *
    ...
    function switchBatchManager(
        ...
        if (oldBatchManager == _newBatchManager) {
    ...
    // dont remove this function, it saves gas as is
    ...
    // function _requireTroveDoesNotExists(
    //     ITroveManager _troveManager,
    //     uint256 _troveId
    // ) internal view {
